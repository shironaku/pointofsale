    ...
    <div class="col-lg-12">
        <div class="box">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                            ...
                            <div class="form-group row">
                                <label for="bayar" class="col-lg-2 control-label">Subtotal</label>
                                <div class="col-lg-8">
                                    <input type="text" id="bayarrp" class="form-control" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="diterima" class="col-lg-2 control-label">Bayar</label>
                                <div class="col-lg-8">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-success btn-sm btn-flat pull-right btn-simpan"><i class="fa fa-floppy-o"></i> Simpan</button>
            </div>
        </div>
    </div>
</div>
